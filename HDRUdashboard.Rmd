...
knitr::opts_chunk$set(fig.width=14, fig.height=10, dpi=450)
...
kable(tbl1,col.names=NULL,row.names=F,caption="Patient characteristics: demographics") %>%
...
kable(tbl2,col.names=NULL,row.names=F,caption="Patient characteristics: medical history") %>%
  kable_styling("striped", full_width = F) %>%
  #add_header_above(c("Demographics" = 1, paste(sep="","Patients to HDRU from ",minDay," to ",maxDay,"[n = ",nrow(admissionData),"]") = 2)) %>%
