...
ggplot(data=admissionsWeekly,mapping=aes(x=week,y=n,fill=countType)) +
...
admissionData$agegrp[admissionData$age <= 30] <- "<30"
admissionData$agegrp[admissionData$age > 30 & admissionData$age <= 39.9] <- "30-49"
