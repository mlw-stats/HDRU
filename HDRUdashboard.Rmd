...
admissionData$admission<-rep(1,nrow(admissionData))
dailyData$admission<-rep(1,nrow(dailyData))
...
admissionData$pidAdm<-paste(sep="_",admissionData$pid,admissionData$admission)
...
admissionData$pfRatio<-
  case_when(admissionData$abga==2 ~ admissionData$abga2/admissionData$abga6,
            admissionData$abga==1 ~ 10^(0.48+0.78*log10(admissionData$ao2sat/admissionData$ao2req))) # doi 10.1097/CCM.0b013e31819cefa9; note log10 in the equation
